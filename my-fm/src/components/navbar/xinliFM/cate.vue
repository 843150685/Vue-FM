<template>
	<div class="category-contaniner">
		<header>
			...
			<div class="nvabar">分类节目</div>
			<span class="serch-box"></span>
		</header>
		<div class="mian-content">
			<van-tabs @change="tocategoryChange" swipeable background="#f2f6f9" line-width="2.4rem" title-active-color="#fa7963" color="#fa7963" v-model="num" animated>
...
export default {
	...
	methods: {
		async getCategoryList() {
			let res = await sc(
				"GET",
				"http://yiapi.xinli001.com/fm/home-list.json",
				{
					params: {
